...
class Elevator:
    ...
    def go_down(self):
        if self.floor > 0:
            ...
            raise ValueError("Cannot go below ground floor")
...
class Flight:
    ...
    def delay(self, delay_time):
        ...
        departure_time += timedelta(minutes=delay_time)
        self.departure = departure_time.strftime("%H:%M") 
...
class Circle:
    ...
    def area(self):
        return round(math.pi * self.radius ** 2, 14) 

    def circumference(self):
        return round(2 * math.pi * self.radius, 14)  
